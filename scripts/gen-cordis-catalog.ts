...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  GameEngineId: 'engine id vocabulary is owned by packages/game/game-runtime/src/types.ts',
  EngineRuntime: 'provider contract is owned by packages/game/game-runtime/README.md',
  GameRunRequest: 'game seam request type is owned by packages/game/game-runtime/src/types.ts',
  GameBuildRequest: 'game seam request type is owned by packages/game/game-runtime/src/types.ts',
  GameBuildResult: 'game seam result type is owned by packages/game/game-runtime/src/types.ts',
  GameLogText: 'game seam result type is owned by packages/game/game-runtime/src/types.ts',
  GameProcess: 'tracked process handle is owned by packages/game/game-runtime/src/types.ts',
  GameReadLogRequest: 'game seam request type is owned by packages/game/game-runtime/src/types.ts',
  SceneQueryRequest: 'game seam request type is owned by packages/game/game-runtime/src/types.ts',
  SceneInfo: 'game seam result type is owned by packages/game/game-runtime/src/types.ts',
  AssetQueryRequest: 'game seam request type is owned by packages/game/game-runtime/src/types.ts',
  AssetInfo: 'game seam result type is owned by packages/game/game-runtime/src/types.ts',
  CaptureRequest: 'game seam request type is owned by packages/game/game-runtime/src/types.ts',
  GameFrame: 'game seam result type is owned by packages/game/game-runtime/src/types.ts',
