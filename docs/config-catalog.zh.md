...
来源：[`packages/game/game-runtime/src/index.ts:96`](../packages/game/game-runtime/src/index.ts)

<a id="deepseek-aidsh-game-runtime-godot"></a>

## `@deepseek-ai/dsh-game-runtime-godot`

需要：`gameRuntimes` · `subprocess`
...
来源：[`packages/game/game-runtime-godot/src/index.ts:60`](../packages/game/game-runtime-godot/src/index.ts)
...
来源：[`packages/game/game-runtime-web/src/index.ts:65`](../packages/game/game-runtime-web/src/index.ts)
...
- `@deepseek-ai/dsh-tool-game` — 需要 `tools` · `gameRuntimes`（[`packages/game/tool-game/src/index.ts`](../packages/game/tool-game/src/index.ts)）
