...
flowchart TD
  ...
  subgraph group_game["packages/game"]
    pkg_game_runtime["game-runtime"]
    pkg_game_runtime_godot["game-runtime-godot"]
    pkg_game_runtime_web["game-runtime-web"]
  ...
  pkg_web --> pkg_llm
  pkg_game_runtime --> pkg_invariants
  pkg_game_runtime --> pkg_llm
  pkg_lsp --> pkg_brand
  ...
  pkg_game_runtime_godot --> pkg_game_runtime
  pkg_game_runtime_godot --> pkg_invariants
  pkg_game_runtime_godot --> pkg_subprocess
  pkg_game_runtime_web --> pkg_game_runtime
  pkg_game_runtime_web --> pkg_invariants
  pkg_game_runtime_web --> pkg_subprocess
  ...
  pkg_tool_game --> pkg_game_runtime
...
| [`game`](../packages/bundle/game) | `bundle` | [`invariants`](../packages/runtime-diagnostics/invariants) |
...
| [`game-runtime`](../packages/game/game-runtime) | `game` | [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm) |
...
| [`game-runtime-godot`](../packages/game/game-runtime-godot) | `game` | [`game-runtime`](../packages/game/game-runtime), [`invariants`](../packages/runtime-diagnostics/invariants), [`subprocess`](../packages/subprocess/subprocess) |
| [`game-runtime-web`](../packages/game/game-runtime-web) | `game` | [`game-runtime`](../packages/game/game-runtime), [`invariants`](../packages/runtime-diagnostics/invariants), [`subprocess`](../packages/subprocess/subprocess) |
...
| [`tool-game`](../packages/game/tool-game) | `game` | [`game-runtime`](../packages/game/game-runtime), [`invariants`](../packages/runtime-diagnostics/invariants), [`tools`](../packages/core/tools) |
