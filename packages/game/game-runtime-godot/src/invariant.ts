/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-game-runtime-godot`.
 * @module @deepseek-ai/dsh-game-runtime-godot/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-game-runtime-godot'

/** Cordis companion plugin name. */
export const name = 'game-runtime-godot-invariant'
